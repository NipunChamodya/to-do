...
function SortableTaskItem({ task, toggleTaskCompletion, handleEdit, handleDeleteTask, editingTaskId, editingText, setEditingText, handleUpdateTask }) {
  ...
  // FIX: Overdue logic now correctly compares dates only.
...
function App() {
  ...
  // --- ROBUST CRUD FUNCTIONS WITH ERROR HANDLING ---
  const handleAddTask = async (e) => {
    ...
    try {
      ...
      alert("Failed to add task. Check console for errors. It might be a Firebase rules issue.");
    }
  };
  ...
  const handleDeleteTask = async (idToDelete) => {
    try {
      ...
      alert("Failed to delete task. Check console for errors. It might be a Firebase rules issue.");
    }
  };
  ...
  const toggleTaskCompletion = async (task) => {
    try {
      ...
      alert("Failed to update task. Check console for errors. It might be a Firebase rules issue.");
    }
  };
  ...
  const handleUpdateTask = async (e) => {
    ...
    try {
      ...
      alert("Failed to save task title. Check console for errors. It might be a Firebase rules issue.");
    }
  };
